<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="online.aspx.cs" Inherits="AppBox.admin.online" %>
        ...
        <Items>
            ...
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                ...
                <Columns>
                    ...
                    <f:BoundField DataField="LoginTime" SortField="LoginTime" Width="120px" DataFormatString="{0:yyyy-MM-dd HH:mm}"
                        HeaderText="登录时间" />
                    <f:BoundField DataField="User.Name" SortField="User.Name" Width="100px" HeaderText="用户名" />
                    <f:BoundField DataField="User.ChineseName" SortField="User.ChineseName" Width="100px" HeaderText="中文名" />
                    <f:BoundField DataField="IPAdddress" ExpandUnusedSpace="true" HeaderText="IP地址" />
                    <f:WindowField Text="查看" Title="查看" WindowID="Window1" DataIFrameUrlFields="User.ID"

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="AppBox.admin._default" %>
...
<body>
    ...
    <f:Panel ID="Panel1" Layout="Column" ShowBorder="false" ShowHeader="false" 
        runat="server">
        <Items>

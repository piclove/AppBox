<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="log.aspx.cs" Inherits="AppBox.admin.log" %>
    ...
    <f:Panel ID="Panel1" runat="server" BodyPadding="5px"  
        ...
        <Items>
            ...
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                EnableCheckBoxSelect="true"  DataKeyNames="Logid" AllowSorting="true"
                OnSort="Grid1_Sort"  SortField="DatetimeX" SortDirection="DESC" AllowPaging="true"
